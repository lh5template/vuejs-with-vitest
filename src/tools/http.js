...
export const registerMapper = (mapper) => responseInterceptor.use((res) => mapper(res.data));
export const removeMapper = (interceptor) => responseInterceptor.eject(interceptor);
